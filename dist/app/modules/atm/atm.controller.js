...
// ! ====== Get  =======
const allAtm = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // totale items
    const count = yield atm_model_1.ATMModel.find(filter).countDocuments();
    // user find
    const users = yield atm_model_1.ATMModel.find(filter)
        .limit(limit)
        .skip((page - 1) * limit);
    if (!users)
...
// ! ====== create  =======
const createAtm = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // Add to database
        const data = yield atm_model_1.ATMModel.create({
            name,
            address,
            distance,
            goOn,
...
// ! ====== Update  =======
const updateAtm = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.file) {
        ...
        const updatedData = yield atm_model_1.ATMModel.findByIdAndUpdate(id, { name, address, distance, goOn, cityId, nearHospitalId }, { new: true });
        if (!updatedData) {
    ...
    const oldData = yield atm_model_1.ATMModel.findById(id);
    if (!oldData) {
        throw new ApiErrors_1.default(404, 'Data not found');
    }
    // Delete old file 
    ...
    // Find the document by ID and update it
    const updatedData = yield atm_model_1.ATMModel.findByIdAndUpdate(id, { name, address, distance, goOn, cityId, nearHospitalId, img: NewFilePath }, { new: true });
    if (!updatedData) {
        throw new ApiErrors_1.default(404, 'Data not found');
    }
    (0, sendResponse_1.default)(res, {
...
// ! ====== Update  =======
const deleteAtm = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.query.id;
    // check id 
    if (!id) {
        throw new ApiErrors_1.default(400, 'id is required');
    ...
    const deletedData = yield atm_model_1.ATMModel.findByIdAndDelete(id);
    if (!deletedData) {
        throw new ApiErrors_1.default(404, 'Data not found');
    }
    (0, sendResponse_1.default)(res, {
...
exports.AtmController = {
    createAtm,
    allAtm,
    updateAtm,
    deleteAtm
};
//# sourceMappingURL=atm.controller.js.map